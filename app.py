...
st.set_page_config(page_title="Protellect", page_icon=":microscope:", layout="wide", initial_sidebar_state="expanded")
...
[data-testid="stSidebar"]{background:#030810!important;border-right:1px solid #0d2545!important;min-width:240px!important;max-width:240px!important}
[data-testid="stSidebar"] [data-testid="stSidebarNav"]{display:none}
[data-testid="stSidebar"] .stButton>button{background:transparent!important;border:1px solid #0d2545!important;color:#d0e8ff!important;font-size:.78rem!important;border-radius:8px!important;font-family:'Space Grotesk',sans-serif!important;width:100%!important;text-align:left!important;padding:.28rem .6rem!important}
[data-testid="stSidebar"] .stButton>button:hover{border-color:#00e5ff44!important;color:#00e5ff!important}
[data-testid="stSidebar"] .stTextInput>div>div>input{background:#040c14!important;border:1px solid #0d2545!important;color:#d0e8ff!important;border-radius:8px!important;font-size:.82rem!important}
[data-testid="stSidebar"] .stSelectbox>div>div{background:#040c14!important;border:1px solid #0d2545!important;color:#d0e8ff!important;border-radius:8px!important}
...
@keyframes pulse{0%,100%{opacity:.4;transform:scale(.97)}50%{opacity:1;transform:scale(1.03)}}
@keyframes glow{0%,100%{box-shadow:0 0 20px #00e5ff22}50%{box-shadow:0 0 45px #00e5ff55}}
...
def render_onboarding():
    st.markdown("<div style='text-align:center;padding:2rem 0 1.2rem;animation:fadeUp .8s ease both'><div style='position:relative;width:80px;height:80px;margin:0 auto .6rem;display:flex;align-items:center;justify-content:center'><div style='position:absolute;inset:0;border:2px solid #00e5ff33;border-radius:50%;animation:glow 3s infinite'></div><span style='font-size:2.2rem;display:inline-block'>&#128300;</span></div><div style='font-size:2.2rem;font-weight:700;color:#00e5ff;letter-spacing:-.03em'>Protellect</div><div style='font-size:.78rem;color:#3a6080;letter-spacing:.08em;text-transform:uppercase'>Personalise your research experience</div><div style='width:40px;height:2px;background:#00e5ff;margin:.6rem auto'></div></div>",unsafe_allow_html=True)
    u=current_user()
...
def render_splash():
    lab=st.session_state.lab or {}
    st.markdown("<div style='text-align:center;padding:2.8rem 1rem 1.5rem;animation:fadeUp .7s ease both'><div style='position:relative;width:90px;height:90px;margin:0 auto .7rem;display:flex;align-items:center;justify-content:center'><div style='position:absolute;inset:0;border:2px solid #00e5ff33;border-radius:50%;animation:glow 3s infinite'></div><div style='position:absolute;width:70px;height:70px;border:1px solid #00e5ff22;border-radius:50%;animation:pulse 3s infinite .5s'></div><span style='font-size:2.5rem'>&#128300;</span></div><div style='font-size:2.5rem;font-weight:700;color:#00e5ff;letter-spacing:-.03em'>Protellect</div><div style='font-size:.77rem;color:#3a6080;letter-spacing:.1em;text-transform:uppercase;margin:.2rem 0'>Biology Intelligence Platform</div><div style='width:42px;height:2px;background:#00e5ff;margin:.7rem auto'></div></div>",unsafe_allow_html=True)
